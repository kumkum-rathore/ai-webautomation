...
const Header = () => {
  ...
  return (
    ...
    <header className="flex justify-between items-center py-6 md:py-8 px-4 sm:px-6 lg:px-8">
      
      
      <div className="text-2xl font-bold">
        <span 
          className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-red-400"
        >
          Ganify
        </span>
      </div>
     ...
     <div >        
      <a href="" className='p-15 m-5'>Home</a>
        <a href="" className='p-5 m-5'>About</a>
        <a href="" className='p-5 m-5'>Testimonials</a>
        <a href="" className='p-5 m-5'>Contact</a>
</div>
<button
