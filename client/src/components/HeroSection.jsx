...
const HeroSection = () => {
  return (
    <section className="flex flex-col items-center justify-center pt-20 pb-28 text-center">
      <div
        className="mb-8 px-5 py-2 rounded-full text-sm font-medium 
                   bg-white/10 border border-white/20 
                   backdrop-blur-sm shadow-xl"
      >
        <span className="text-purple-400 font-bold mr-2">NEW</span>
      ...
      <span className="mt-10 text-3xl">--------trusted by 500 + companies----------</span>
    </section>
  );
};
