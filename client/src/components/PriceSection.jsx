  ...
  return (
    <div>
      <section className="flex flex-col items-center justify-center pt-20 pb-28 text-center">
        ...
        <div className=" mt-10 group relative flex justify-center items-center text-zinc-600 text-sm font-bold">
          {/* Tooltip box */}
          ...
          <div className="shadow-md flex items-center group-hover:gap-2 bg-gradient-to-br from-lime-200 to-yellow-200 p-3 rounded-full cursor-pointer duration-300">
            ...
            <span className="text-[0px] group-hover:text-sm duration-300">Annually</span>
          </div>
        </div>
